                    ...
                    case Normal -> {
                        ...
                        if (over instanceof BlockHitResult block) {
                            ...
                            if (isTop) {
                                ...
                                switch (axis) {
                                    case X -> {
                                        ebox = new Vec3d(qMax ? box.maxX - 0.05 : box.minX + 0.05, ebox.y, ebox.z);
                                    }
                                    case Z -> {
                                        ebox = new Vec3d(ebox.x, ebox.y, qMax ? box.maxZ - 0.05 : box.minZ + 0.05);
                                    }
                                }
                                ...
                                switch (axis) {
                                    case X -> {
                                        ebox = new Vec3d(qMax ? box.minX : box.maxX, ebox.y, qMax ? box.minZ + 0.05 : box.maxZ - 0.05);
                                    }
                                    case Z -> {
                                        ebox = new Vec3d( qMax ? box.minX + 0.05 : box.maxX - 0.05, ebox.y, qMax ? box.minZ : box.maxZ);
                                    }
                                }
