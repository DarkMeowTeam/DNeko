...
import net.darkmeow.dneko.inject.accessor.AccessorBucketItem;
...
public class ItemCategorization {
    ...
    public ItemFacet[] getItemFacets(ItemSlot slot) {
        ...
        if (item instanceof ArmorItem) {
            ...
            if (((AccessorBucketItem) bucketItem).getFluid() instanceof WaterFluid) {
                specificItemFacets.add(new PrimitiveItemFacet(slot, new ItemCategory(ItemType.BUCKET, 0)));
            } else if (((AccessorBucketItem) bucketItem).getFluid() instanceof LavaFluid) {
