...
import net.darkmeow.dneko.inject.accessor.AccessorClientPlayerEntity;
...
public class PlayerUtils {
    ...
    public static float getMoveYaw(float yaw) {
        Rotation from = new Rotation((float) ((AccessorClientPlayerEntity) mc.player).getLastX(), (float) ((AccessorClientPlayerEntity) mc.player).getLastZ()),
